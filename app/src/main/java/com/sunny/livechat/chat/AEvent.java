...
public class AEvent {
    ...
    public static void addListener(String eventID, IChatListener eventListener){
    ...
    public static void removeListener(String eventID, IChatListener eventListener){
        int i;
        EventObj event;
