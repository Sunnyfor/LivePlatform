...
public class DensityUtils {
    ...
    public static int getNavBarHeight(Context c) {
        ...
        if (isTablet(c)) {
            resourceId = resources.getIdentifier(
                    orientation == Configuration.ORIENTATION_PORTRAIT ? "navigation_bar_height" : "navigation_bar_height_landscape", "dimen",
                    "android");
        } else {
            resourceId = resources.getIdentifier(orientation == Configuration.ORIENTATION_PORTRAIT ? "navigation_bar_height" : "navigation_bar_width",
                    "dimen", "android");
        }
        if (resourceId > 0) {
    ...
    public static int getSoftKeyBoardHeight(Context context) {
        int height = screenHeight(context);
        return height * 2 / 5;
    }
