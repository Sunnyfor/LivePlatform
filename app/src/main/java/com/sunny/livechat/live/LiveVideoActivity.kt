...
//            val msgText = msgList[position].contentData
    ...
    override fun dispatchEvent(aEventID: String?, success: Boolean, eventObj: Any?) {
        ...
        when (aEventID) {
            ...
            AEvent.AEVENT_LIVE_APPLY_LINK -> AlertDialog.Builder(this).setCancelable(
                true
            )
            ...
            AEvent.AEVENT_LIVE_INVITE_LINK -> AlertDialog.Builder(this).setCancelable(
                true
            )
